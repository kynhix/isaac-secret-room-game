    ...
    <div class='relative w-full overflow-y-auto'>
      <div class='w-full min-h-screen h-fit flex flex-col'>
        <div class='p-8 flex justify-between w-full'>
          <h1 class='hidden md:block text-3xl px-8 py-6 font-bold tracking-tighter text-blue-100 shadow shadow-[#03070CaF] bg-gray-900'>Secret Room Game</h1>
          <div class="flex gap-2">
            <div class='flex items-center text-3xl tracking-tight font-bold p-2 bg-gray-900 shadow shadow-[#03070CaF] text-rose-100'>
            ...
            <div class='flex items-center text-3xl tracking-tight font-bold p-2 bg-gray-900 shadow shadow-[#03070CaF] text-orange-100'>
